...
for cond in conditions:
    ...
    # High-pass filter
    data.filter(l_freq=1, h_freq=None, picks=['eeg', 'eog'])
    ...
    data.filter(l_freq=None, h_freq=80, picks=['eeg', 'eog'])
    ...
    # Save epoched data
    eData.save((outpath + filename + '_clean_epo.fif'))
